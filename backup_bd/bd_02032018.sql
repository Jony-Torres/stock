...
INSERT INTO `articulo` VALUES ('AA1','UN','0','LED TOKYO 32 PULG',5,'GRAL','GRAL',NULL,NULL,NULL,'10','A','S'),('AA3','UN','3','MICROONDAS MIDAS',7,NULL,NULL,NULL,NULL,NULL,'10','A','S');
...
CREATE TABLE `comprobante_detalle_compra` (
  ...
  CONSTRAINT `FK_COMP_CM_DET_EXIST_ART` FOREIGN KEY (`cod_producto`, `cod_un_med`, `nro_lote`) REFERENCES `existencia_articulo` (`cod_articulo`, `cod_un_medida`, `nro_lote`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `existencia_articulo` VALUES ('01','01','AA1','UN','0',3,7,5);
...
INSERT INTO `saldo_proveedor` VALUES ('FCR','001-001',1,1,'01',1,'2018-03-12',2500000,'01',2500000,'root'),('FCR','001-001',2,1,'01',1,'2018-05-12',7500000,'01',7500000,'root'),('FCR','001-001',3,1,'01',NULL,NULL,NULL,NULL,NULL,'root'),('FCR','001-001',123,1,'01',5,NULL,NULL,NULL,NULL,'root'),('FCR','001-001',124,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2018-03-02 15:58:37
