...
INSERT INTO `comprobante_cabecera_compra` VALUES ('FCR','001-001',1,'123','2018-04-04','root','01','01',5,3,3,'2018-04-04',0,3300000,300000,3000000,'01',0,'P',NULL),('FCR','001-001',2,'123','2018-04-04','root','01','01',6,4,4,'2018-04-04',0,2000000,95238,1904762,'01',0,'P',NULL);
...
INSERT INTO `comprobante_cabecera_venta` VALUES ('FCO','A',3,'01','01','2018-05-02',1,NULL,NULL,NULL,NULL,NULL,0,NULL,'01',NULL,800000,727273,NULL,72727,'P','root',NULL,0,NULL,NULL),('FCR','A',1,'01','01','2018-05-02',1,NULL,NULL,NULL,NULL,NULL,1,NULL,'01',NULL,500000,454545,NULL,45455,'A','root',NULL,500000,NULL,1),('FCR','A',2,'01','01','2018-05-02',4,NULL,NULL,NULL,NULL,NULL,3,NULL,'01',NULL,1500000,1363636,NULL,136364,'P','root',NULL,500000,NULL,NULL);
...
INSERT INTO `comprobante_detalle_compra` VALUES ('FCR','001-001',1,'AA1','UN','0','LED TOKYO 32 PULG',2,1200000,0,2400000,0,218182,0,2181818),('FCR','001-001',1,'AA3','UN','3','MICROONDAS MIDAS',3,300000,0,900000,0,81818,0,818182),('FCR','001-001',2,'AA1','UN','1','LED TOKYO 32 PULG LOT1',2,1000000,0,2000000,95238,0,1904762,0);
...
INSERT INTO `comprobante_detalle_venta` VALUES ('FCO','A',3,'AA3','UN','3','MICROONDAS MIDAS',1,800000,0,727273,0,800000,72727,0,0,0,0,1),('FCR','A',1,'AA3','UN','3','MICROONDAS MIDAS',1,500000,0,454545,0,500000,45455,0,0,0,0,1),('FCR','A',2,'AA1','UN','0','LED TOKYO 32 PULG',1,1500000,0,1363636,0,1500000,136364,0,0,0,0,1);
...
INSERT INTO `existencia_articulo` VALUES ('01','01','AA1','UN','0',3,7,2),('01','01','AA1','UN','0',4,10,1),('01','01','AA1','UN','1',3,7,2),('01','01','AA3','UN','3',3,7,3),('01','01','AA3','UN','3',4,10,1);
...
INSERT INTO `forma_pago_compra` VALUES ('CAJ','A',1,2,4,NULL,'','',1500000);
...
INSERT INTO `movimiento_caja_compra` VALUES ('CAJ','A',1,'2018-03-27','01',5,'root',NULL,NULL,1500000,NULL,NULL);
...
INSERT INTO `saldo_cliente` VALUES ('FCR','A',1,1,'01',1,'2018-06-02',500000,'01',500000,'root'),('FCR','A',2,1,'01',4,'2018-06-02',500000,'01',500000,'root'),('FCR','A',2,2,'01',4,'2018-07-02',500000,'01',500000,'root'),('FCR','A',2,3,'01',4,'2018-08-02',500000,'01',500000,'root');
...
INSERT INTO `saldo_proveedor` VALUES ('FCR','001-001',1,1,'01',5,'2018-07-04',3300000,'01',3300000,'root'),('FCR','001-001',2,1,'01',6,'2018-08-04',2000000,'01',2000000,'root');
...
INSERT INTO `serie_comprobante` VALUES ('FCO','A','01',1,1000,'001-001','123456','2019-04-16'),('FCO','B','01',1,1000,'001-002','123456','2019-04-16'),('FCR','A','01',1,1000,'001-001','123456','2019-04-16'),('FCR','B','01',1,1000,'001-002','1234567','2019-04-16');
...
INSERT INTO `talonario` VALUES ('FCO','A','01',1,1,1000,'A'),('FCO','B','01',1,1,1000,'A'),('FCR','A','01',1,1,1000,'A'),('FCR','B','01',1,1,1000,'A');
...
INSERT INTO `talonario_usuario` VALUES ('FCO','A','01',1,'root'),('FCO','B','01',1,'root'),('FCR','A','01',1,'root'),('FCR','B','01',1,'root');
...
INSERT INTO `tipo_comprobante` VALUES ('FCO','VT','FACTURA CONTADO',10),('FCR','VT','FACTURA CREDITO',10);
...
-- Dump completed on 2018-05-04 16:09:29
