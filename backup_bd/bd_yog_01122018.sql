...
('A001','UN','0','ARTICULO DE PRUEBA1',5,NULL,NULL,NULL,NULL,NULL,'10','A','S'),
('A002','UN','0','ART PRUEBA2',6,NULL,NULL,NULL,NULL,NULL,'10','A','S'),
('A003','UN','0','ARTICU PRUEBA 3',5,NULL,NULL,NULL,NULL,NULL,'10','A','S'),
('A004','UN','0','ARTICULO DE PRUEBA4',6,NULL,NULL,NULL,NULL,NULL,'10','A','S'),
('A005','UN','0','ART PRUEBA5',7,NULL,NULL,NULL,NULL,NULL,'10','A','S');
...
('FCR','001-001',123,'12345','2018-11-29','root','01','01',5,3,3,'2018-11-29',0,3750000,340909,3409091,'01',0,'P',NULL),
('FCR','001-001',1234,'123456','2018-11-29','root','01','01',6,1,1,'2018-11-29',0,2750000,250000,2500000,'01',0,'P',NULL),
('FCR','001-001',12345,'123456','2018-11-29','root','01','01',5,3,3,'2018-11-29',0,7000000,636363,6363637,'01',0,'P',NULL);
...
('FCR','001-001',123,'A001','UN','0','ARTICULO DE PRUEBA1',5,750000,0,3750000,0,340909,0,3409091),
('FCR','001-001',1234,'A002','UN','0','ART PRUEBA2',5,550000,0,2750000,0,250000,0,2500000),
('FCR','001-001',12345,'A003','UN','0','ARTICU PRUEBA 3',5,800000,0,4000000,0,363636,0,3636364),
('FCR','001-001',12345,'A004','UN','0','ARTICULO DE PRUEBA4',5,600000,0,3000000,0,272727,0,2727273);
...
('01','01','A001','UN','0',3,7,5.00),
('01','01','A001','UN','0',4,10,0.00),
('01','01','A002','UN','0',3,7,5.00),
('01','01','A003','UN','0',3,7,5.00),
('01','01','A004','UN','0',3,7,5.00);
...
CREATE TABLE `forma_cobro_venta` (
  ...
  `monto` decimal(16,5) DEFAULT NULL,
...
CREATE TABLE `movimiento_caja_venta` (
  ...
  `cod_usuario` varchar(15) DEFAULT NULL,
  `numero_hab` int(11) DEFAULT NULL,
  `total_mov_caja` decimal(16,5) DEFAULT NULL,
  `anulado` varchar(1) DEFAULT NULL,
...
CREATE TABLE `movimiento_comprobante_venta` (
  ...
  `total_comprobante` decimal(16,5) DEFAULT NULL,
...
(20,'PERSONA DE PRUEBA',NULL,NULL,1,'ASUNCION',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'N');
...
('FCR','001-001',123,1,'01',5,'2019-02-28',3750000,'01',3750000,'root'),
('FCR','001-001',1234,1,'01',6,'2018-12-29',2750000,'01',2750000,'root'),
('FCR','001-001',12345,1,'01',5,'2019-02-28',7000000,'01',7000000,'root');
