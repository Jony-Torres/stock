 ...
 */
public class FORMMARART extends javax.swing.JFrame {

    /**
     * Creates new form FORMMARART
     */
    public FORMMARART() {
        initComponents();
...
private void cerrar_ventan_marca() {
        setDefaultCloseOperation(FORMMARART.DO_NOTHING_ON_CLOSE);
   ...
   public void cerrar_ventanamarca(){
    ...
    private void initComponents() {
        ...
        setTitle("CARGA DE MARCAS(FORMMARART)");
        setResizable(false);
        ...
        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 60, 640, 220));
        ...
        jPanel2.add(txt_cod_marca, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, 70, 20));

        txt_desc_marca.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txt_desc_marcaKeyTyped(evt);
            }
        });
        jPanel2.add(txt_desc_marca, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 20, 250, 20));
    ...
    private void txt_desc_marcaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_desc_marcaKeyTyped
        int num = 50;
        if (txt_desc_marca.getText().length() >= num) {
            evt.consume();
        }
        char charecter = evt.getKeyChar();
        if (Character.isLowerCase(charecter)) {
    ...
    }//GEN-LAST:event_txt_desc_marcaKeyTyped
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FORMMARART.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FORMMARART().setVisible(true);
            }
        });
    }
    ...
    public void habilita_campos() {
        ...
        txt_desc_marca.setEditable(true);
        txt_cod_marca.requestFocus();
    }
